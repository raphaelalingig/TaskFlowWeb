...
const PriorityDropdown = () => {
  const [selectedPriority, setSelectedPriority] = useState("Active");
        ...
        {isPriorityOpen && (
          ...
          >
            <ul className="py-2 text-sm text-gray-700 dark:text-gray-200 ">
              <li>
                <button
                  onClick={() => handlePrioritySelect("Delayed")}
              ...
              <li>
                <button
                  onClick={() => handlePrioritySelect("Cancelled")}
                  className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white w-full text-left"
                >
                  Cancelled
                </button>
              ...
              <li>
                <button
                  onClick={() => handlePrioritySelect("Completed")}
                  className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white w-full text-left"
                >
                  Completed
                </button>
